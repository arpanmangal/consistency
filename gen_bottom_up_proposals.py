...
from ops.coinsmallnet_db import COINSMALLDB
...
parser.add_argument("--dataset", type=str, default='activitynet', choices=['activitynet', 'thumos14', 'coin'])
